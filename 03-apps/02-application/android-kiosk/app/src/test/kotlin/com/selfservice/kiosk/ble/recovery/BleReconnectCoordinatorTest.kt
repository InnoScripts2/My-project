...
import com.selfservice.kiosk.ble.recovery.BleReconnectCoordinator.ConnectionIssue
import com.selfservice.kiosk.ble.recovery.BleReconnectCoordinator.IssueType
import com.selfservice.kiosk.ble.recovery.BleReconnectCoordinator.RecoveryDecision
import com.selfservice.kiosk.ble.recovery.BleReconnectCoordinator.RecoveryPolicy
import com.selfservice.kiosk.ble.recovery.BleReconnectCoordinator.Severity
...
class BleReconnectCoordinatorTest {
    ...
    fun retryRespectsMaxAttemptsAndResets() {
        ...
        val first = assertIs<RecoveryDecision.Retry>(coordinator.nextAction(issue))
        assertEquals(1, first.attempt)
        assertEquals(1_000L, first.delayMillis)

        val second = assertIs<RecoveryDecision.Retry>(coordinator.nextAction(issue))
        ...
        val reset = assertIs<RecoveryDecision.Retry>(coordinator.nextAction(issue))
