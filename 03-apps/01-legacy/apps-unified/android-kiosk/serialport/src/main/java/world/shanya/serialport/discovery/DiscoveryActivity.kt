...
class DiscoveryActivity : AppCompatActivity() {
    ...
    private lateinit var unpairedRecyclerView: RecyclerView
    ...
    */
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        swipeRefreshLayout = findViewById(R.id.swipeRedreshLayout)
        pairedRecyclerView = findViewById(R.id.recyclerViewPaired)
        unpairedRecyclerView = findViewById(R.id.recyclerViewUnpaired)
    ...
    inner class DevicesAdapter internal constructor(context: Context, private val pairingStatus: Boolean) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DevicesViewHolder {
            ...
            holder.itemView.setOnClickListener {
                SerialPortDiscovery.stopLegacyScan(this@DiscoveryActivity)
                SerialPortDiscovery.stopBleScan()
                val device = SerialPort.bluetoothAdapter.getRemoteDevice(holder.textViewDeviceAddress.text.toString())
