      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'actions'">
            <a-space>
              <a-button size="small" @click="handleRestart(record.kioskId)"
                >Restart</a-button
              >
              <a-button size="small" @click="handleViewLogs(record.kioskId)"
                >View Logs</a-button
              >
              <a-button size="small" @click="handleConfigure(record.kioskId)"
                >Configure</a-button
              >
            </a-space>
          </template>
...
async function handleRestart(kioskId: string) {
  ...
  if (result.success) {
    ...
    notification.error({
      message: "Failed to restart kiosk",
