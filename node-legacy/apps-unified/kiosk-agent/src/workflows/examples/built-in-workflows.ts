 ...
 */
export const autoRestartWorkflow: WorkflowDefinition = {
 ...
 */
export const dailyCleanupWorkflow: WorkflowDefinition = {
  name: 'daily_cleanup',
 ...
 */
export const syncOrchestrationWorkflow: WorkflowDefinition = {
