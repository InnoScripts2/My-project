...
export class AutoUpdateManager {
   ...
   */
  async downloadUpdate(manifest: UpdateManifest): Promise<{ success: boolean; error?: string }> {
    const state = await this.getState();
   ...
   */
  async validateUpdate(): Promise<{ success: boolean; error?: string }> {
    const state = await this.getState();
   ...
   */
  private canApplyUpdate(manifest: UpdateManifest): boolean {
