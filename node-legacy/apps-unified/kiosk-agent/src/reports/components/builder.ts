 ...
 */
export async function buildHtml(sessionData: ThicknessReportData | ObdReportData): Promise<string> {
 ...
 */
export async function buildPdf(sessionData: ThicknessReportData | ObdReportData): Promise<Uint8Array> {
  const type = isThicknessData(sessionData) ? 'thickness' : 'obd'
...
function isThicknessData(data: ThicknessReportData | ObdReportData): data is ThicknessReportData {
