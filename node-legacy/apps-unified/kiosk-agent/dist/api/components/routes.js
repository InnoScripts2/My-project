...
export function registerRoutes(app, registry) {
    ...
    app.get('/api/obd/status', asyncHandler(async (req, res) => {
        res.json({
            connected: false,
            protocol: null,
            vin: null,
    ...
    app.post('/api/obd/scan', validateBody(obdScanRequestSchema), asyncHandler(async (req, res) => {
        const { mode } = req.body;
    ...
    app.get('/api/obd/scan/:sessionId', asyncHandler(async (req, res) => {
    ...
    app.post('/api/obd/clear-dtc', validateBody(obdClearDtcSchema), asyncHandler(async (req, res) => {
        res.json({
            status: 'success',
    ...
    app.get('/api/thickness/status', asyncHandler(async (req, res) => {
        res.json({
            connected: false,
            battery: null,
    ...
    app.post('/api/thickness/start', validateBody(thicknessStartSchema), asyncHandler(async (req, res) => {
    ...
    app.post('/api/thickness/measure', validateBody(thicknessMeasureSchema), asyncHandler(async (req, res) => {
    ...
    app.post('/api/thickness/finish', validateBody(thicknessFinishSchema), asyncHandler(async (req, res) => {
    ...
    app.post('/api/payment/intent', validateBody(paymentIntentSchema), asyncHandler(async (req, res) => {
    ...
    app.get('/api/payment/status/:intentId', asyncHandler(async (req, res) => {
    ...
    app.post('/api/payment/confirm-dev', asyncHandler(async (req, res) => {
    ...
    app.get('/api/selfcheck', asyncHandler(async (req, res) => {
    ...
    app.post('/api/lock/open', validateBody(lockOpenSchema), asyncHandler(async (req, res) => {
