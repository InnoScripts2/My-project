...
import { PredictiveDiagnostics } from './predictive-diagnostics.js';
describe('PredictiveDiagnostics', () => {
    ...
    describe('predictComponentLifespan', () => {
        it('should predict oxygen sensor lifespan', async () => {
            ...
            const prediction = await diagnostics.predictComponentLifespan('oxygen_sensor', 80000, history);
        ...
        it('should account for high mileage', async () => {
            const diagnostics = new PredictiveDiagnostics();
            const history = [];
            const prediction = await diagnostics.predictComponentLifespan('spark_plugs', 120000, history);
        ...
        it('should provide confidence intervals', async () => {
            const diagnostics = new PredictiveDiagnostics();
            const prediction = await diagnostics.predictComponentLifespan('battery', 40000, []);
