...
export function createMediaRoutes() {
    const router = Router();
    router.post('/api/media/transform', async (req, res) => {
    ...
    router.get('/api/media/cache/stats', async (req, res) => {
        try {
    ...
    router.delete('/api/media/cache', async (req, res) => {
        try {
    ...
    router.get('/api/media/presets', async (req, res) => {
        try {
