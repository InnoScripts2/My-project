...
async function runSmokeTests() {
    ...
    const thicknessReport = await reportService.generateReport('smoke-test-thickness', ReportType.THICKNESS, thicknessData);
    ...
    const obdReport = await reportService.generateReport('smoke-test-obd', ReportType.DIAGNOSTICS, obdData);
