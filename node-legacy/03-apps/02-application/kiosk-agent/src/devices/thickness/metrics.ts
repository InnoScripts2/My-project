...
export function registerThicknessAnalysisMetrics(registry: Registry) {
...
export type ThicknessAnalysisMetrics = ReturnType<typeof registerThicknessAnalysisMetrics>;

export function registerThicknessDriverMetrics(registry: Registry) {
...
export type ThicknessDriverMetrics = ReturnType<typeof registerThicknessDriverMetrics>;
