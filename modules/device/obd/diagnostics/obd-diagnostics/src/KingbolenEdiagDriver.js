...
export class KingbolenEdiagDriver extends EventEmitter {
    ...
    txCharacteristic; // noble Characteristic для отправки
    rxCharacteristic; // noble Characteristic для получения
    connected = false;
    options;
    // Хендлеры событий для корректной очистки слушателей
    nobleStateChangeHandler;
    ...
    latencySuccessAccumMs = 0;
    latencyErrorAccumMs = 0;
    isActiveReconnectAttempt = false;
    lastReconnectStartTs = null;
    watchdogTimer = null;
