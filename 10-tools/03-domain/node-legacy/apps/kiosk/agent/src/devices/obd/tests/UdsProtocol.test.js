 ...
 */
class MockObdDriver extends EventEmitter {
...
describe('UdsProtocol', () => {
    describe('switchSession', () => {
        ...
        it('should throw on negative response', async () => {
            ...
            const uds = new UdsProtocol(driver);
            await assert.rejects(async () => await uds.switchSession(0x01), (error) => {
    ...
    describe('readDataByIdentifier', () => {
        ...
        it('should handle negative response', async () => {
            ...
            const uds = new UdsProtocol(driver);
            await assert.rejects(async () => await uds.readDataByIdentifier(0xF190), (error) => {
    ...
    describe('ecuReset', () => {
        it('should require confirmation for ECU reset', async () => {
            ...
            await assert.rejects(async () => await uds.ecuReset(0x01, false), /confirmation/i);
        });
        ...
        it('should handle negative response for ECU reset', async () => {
            ...
            const uds = new UdsProtocol(driver);
            await assert.rejects(async () => await uds.ecuReset(0x01, true), (error) => {
    ...
    describe('error handling', () => {
        it('should throw appropriate errors for malformed responses', async () => {
            ...
            const uds = new UdsProtocol(driver);
            await assert.rejects(async () => await uds.readDataByIdentifier(0x0100));
        });
