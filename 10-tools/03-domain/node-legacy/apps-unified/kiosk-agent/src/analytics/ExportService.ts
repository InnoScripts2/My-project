...
import { QueryResult, UploadResult } from './types.js';
import { Counter, Histogram, Registry } from 'prom-client';

export class ExportService {
  private exportsDir: string;
  private metrics: {
    exportFilesTotal: Counter<string>;
    exportDuration: Histogram<string>;
  };

  constructor(exportsDir?: string, registry?: Registry) {
   ...
   * Экспорт в CSV
   */
  async exportToCsv(results: QueryResult, filePath: string): Promise<string> {
   ...
   * Экспорт в JSON
   */
  async exportToJson(results: QueryResult, filePath: string): Promise<string> {
   ...
   * Экспорт в Excel
   */
  async exportToExcel(results: QueryResult, filePath: string): Promise<string> {
