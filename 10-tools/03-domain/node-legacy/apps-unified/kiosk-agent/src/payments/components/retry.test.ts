...
import type { PaymentProvider, PaymentStatus, PaymentIntent } from '@selfservice/payments'
...
describe('Payment Status Poller', () => {
  ...
  class MockProvider implements PaymentProvider {
    ...
    setStatusSequence(intentId: string, statuses: PaymentStatus[]) {
    ...
    async confirmDevOnly(): Promise<PaymentIntent> {
      throw new Error('Not implemented in mock')
    }

    async markManualConfirmation(): Promise<PaymentIntent> {
      throw new Error('Not implemented in mock')
    }
  }
