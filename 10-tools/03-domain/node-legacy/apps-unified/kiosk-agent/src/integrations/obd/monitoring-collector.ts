...
export interface ObdMetrics {
  ...
  scanCompleted: Counter;
  scanDuration: Histogram;
  dtcCount: Histogram;
  paymentConversion: Counter;
  reportGeneration: Histogram;
  reportDelivery: Counter;
  errors: Counter;
  activeSessions: Gauge;
  adapterLockStatus: Gauge;
}

export class ObdMonitoringCollector {
  private metrics: ObdMetrics;
  ...
  private registerMetrics(): ObdMetrics {
  ...
  recordConnectionAttempt(
    transport: 'bluetooth' | 'usb' | 'serial',
    success: boolean,
   ...
   */
  recordPaymentConversion(successful: boolean): void {
   ...
   */
  recordReportGeneration(durationSeconds: number): void {
   ...
   */
  recordError(
    type: 'connection' | 'scan' | 'payment' | 'report',
   ...
   */
  updateAdapterLockStatus(locked: boolean): void {
 ...
 */
let monitoringCollectorInstance: ObdMonitoringCollector | null = null;

export function getObdMonitoringCollector(registry?: Registry): ObdMonitoringCollector {
