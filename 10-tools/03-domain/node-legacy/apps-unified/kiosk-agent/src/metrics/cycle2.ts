...
export function registerCycle2Metrics(registry: Registry) {
  // Payments metrics
...
let metricsInstance: ReturnType<typeof registerCycle2Metrics> | null = null;

export function getCycle2Metrics(registry: Registry): ReturnType<typeof registerCycle2Metrics> {
  if (!metricsInstance) {
