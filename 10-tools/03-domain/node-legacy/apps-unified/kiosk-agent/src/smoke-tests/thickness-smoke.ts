...
async function testGetSnapshot(): Promise<SmokeTestResult> {
...
async function testPointsTemplate(): Promise<SmokeTestResult> {
...
async function testOpen(): Promise<SmokeTestResult> {
...
async function testSession(): Promise<SmokeTestResult> {
...
async function testDevMarkPoint(): Promise<SmokeTestResult> {
