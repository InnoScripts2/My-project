...
export class FirezoneClient {
    ...
    async registerResource(resourceId, name, tags) {
        try {
            ...
            throw new Error(`Failed to register resource: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    async updateAccessPolicy(resourceId, policy) {
        try {
            ...
            throw new Error(`Failed to update access policy: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    ...
    async rotateKeys() {
        try {
            ...
            throw new Error(`Failed to rotate keys: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    generateDeviceToken() {
