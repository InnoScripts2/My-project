...
async function archiveReportExample() {
    ...
    await seafileClient.init(process.env.SEAFILE_SERVER_URL, process.env.SEAFILE_USERNAME, process.env.SEAFILE_PASSWORD, process.env.SEAFILE_LIBRARY_ID);
    const archiveService = new ArchiveService(seafileClient, reportService);
    // Generate a diagnostic report
    const report = await reportService.generateReport('session-123', ReportType.DIAGNOSTICS, {
...
export { archiveReportExample, scheduleSyncExample, retentionPolicyExample, apiExample };
