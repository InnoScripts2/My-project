 ...
 */
import { ActivepiecesClient, WorkflowManager, WorkflowExecutor, WorkflowTriggerHandler, getWorkflowMetrics, builtInWorkflows, } from '../index.js';
import { createWorkflowRoutes } from '../../api/routes/workflows.routes.js';
/**
 * Initialize workflow automation system
 */
export async function initializeWorkflows(app, eventEmitter, registry) {
 ...
 */
export function setupAlertWorkflowIntegration(eventEmitter, executor, manager) {
    eventEmitter.on('alert_triggered', async (alert) => {
