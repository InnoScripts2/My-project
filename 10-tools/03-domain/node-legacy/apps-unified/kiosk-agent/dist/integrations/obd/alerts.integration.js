 ...
 */
export function evaluateObdAlerts(snapshot, input) {
    const alerts = [];
...
export function createObdMetricsSnapshot(data) {
    ...
    let adapterUnavailableDuration;
 ...
 */
export function formatObdAlertForNotification(alert) {
