...
export function loadObdConfig() {
    ...
    const config = {
        ...
        reporting: {
            pdfEngine: process.env.OBD_PDF_ENGINE || 'puppeteer',
            paths: {
        ...
        dev: {
            ...
            mockScenario: process.env.OBD_MOCK_SCENARIO,
 ...
 */
export function getObdConfig(overrides) {
 ...
 */
export function validateObdConfig(config) {
    const errors = [];
 ...
 */
export function logObdConfig(config) {
    const sanitized = {
        connection: {
