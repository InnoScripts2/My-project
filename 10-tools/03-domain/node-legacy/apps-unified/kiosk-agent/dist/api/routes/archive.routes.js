...
export function createArchiveRoutes() {
    ...
    router.post('/api/reports/:reportId/archive', async (req, res) => {
    ...
    router.get('/api/reports/archived/:reportId', async (req, res) => {
        const { reportId } = req.params;
        try {
            await initializeServices();
    ...
    router.post('/api/reports/sync', async (req, res) => {
        try {
            await initializeServices();
    ...
    router.get('/api/reports/sync/:syncId', async (req, res) => {
