...
export function createObdPaymentRoutes(paymentAdapter) {
    const router = Router();
    // Create payment intent for diagnostics
    router.post('/api/obd/payment/create', async (req, res) => {
    ...
    router.get('/api/obd/payment/status/:intentId', async (req, res) => {
    ...
    router.post('/api/obd/payment/confirm', async (req, res) => {
