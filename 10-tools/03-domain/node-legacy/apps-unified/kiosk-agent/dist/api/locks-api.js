 ...
 * Open lock endpoint
 */
export async function openLock(req, res, lockController) {
    try {
 ...
 * Close lock endpoint
 */
export async function closeLock(req, res, lockController) {
    try {
        const deviceType = DeviceTypeSchema.parse(req.params.deviceType);
 ...
 * Test lock endpoint
 */
export async function testLock(req, res, lockController) {
    try {
        const deviceType = DeviceTypeSchema.parse(req.params.deviceType);
 ...
 */
export async function getLockStatus(req, res, lockController) {
    try {
        const deviceType = DeviceTypeSchema.parse(req.params.deviceType);
 ...
 */
export async function emergencyUnlock(req, res, lockController) {
    try {
 ...
 */
export async function getLockMetrics(req, res, lockController) {
    try {
