...
async function exampleUsage() {
    ...
    driver.on('measurement-complete', (summary) => {
        ...
        const abnormal = summary.measurements.filter((m) => !m.isNormal);
...
async function exampleWithProgress() {
    ...
    driver.on('measurement-complete', (summary) => {
        ...
        const avgThickness = summary.measurements.reduce((sum, m) => sum + m.value, 0) / summary.measurements.length;
...
export { exampleUsage, exampleWithProgress, exampleWithDisconnectHandling, };
