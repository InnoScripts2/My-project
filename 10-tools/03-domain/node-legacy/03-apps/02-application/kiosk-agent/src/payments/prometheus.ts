...
import { PaymentModule } from './module.js';

export interface PaymentsPrometheusCollector {
  readonly register: Registry;
  update(): void;
}

export interface PaymentsPrometheusOptions {
  register?: Registry;
}

export function createPaymentsPrometheusCollector(paymentModule: PaymentModule, options: PaymentsPrometheusOptions = {}): PaymentsPrometheusCollector {
