...
async function testCreateIntent(service: any): Promise<SmokeTestResult> {
...
async function testGetStatus(service: any, intentId: string): Promise<SmokeTestResult> {
...
async function testGetIntent(service: any, intentId: string): Promise<SmokeTestResult> {
...
async function testConfirmDevOnly(service: any, intentId: string): Promise<SmokeTestResult> {
...
async function testStatusPolling(service: any, intentId: string): Promise<SmokeTestResult> {
