...
describe('ObdCache', () => {
  it('should cache and retrieve values', () => {
    const cache = new ObdCache<string>(100, 1000);
  ...
  it('should evict LRU entries when max size reached', () => {
    const cache = new ObdCache<string>(3, 1000);
  ...
  it('should expire entries based on TTL', async () => {
    const cache = new ObdCache<string>(100, 100); // 100ms TTL
  ...
  it('should update access order on get', () => {
    const cache = new ObdCache<string>(2, 1000);
